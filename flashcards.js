...
function createCard() {
    inquirer.prompt([
        {
            type: "list",
            message: "Hello, Please select the type of flashcard you want to create",
        ...
        var cardType = InputInfo.cardType;  			//the cardType variable will store the option from the cardType inquirer object.
...
function shuffleDeck() {
  ...
  console.log("All flashcards have been shuffled");
  ...
  playedCard = getQuestion(library[randomNumber]);	
        inquirer.prompt([							
            ...
            if (answer.question === library[randomNumber].back || answer.question === library[randomNumber].cloze) {
                ...
                if (drawnCard.front !== undefined) { 
                    console.log(("Sorry, the correct answer is ") + library[randomNumber].back + "."); 
                    setTimeout(openMenu, 1000);
                } else { 
                    console.log(("Sorry, the correct answer is ") + library[randomNumber].cloze + ".");
                    setTimeout(openMenu, 1000);
                }
            }
        });
